...
namespace Tangy.Data.Migrations
{
    ...
    [Migration("20180724185911_Add_OrderHeader_and_OrderDetails_Models")]
    partial class Add_OrderHeader_and_OrderDetails_Models
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tangy.Areas.Identity.Data.TangyUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TangyUser");
                });
            ...
            modelBuilder.Entity("Tangy.Models.OrderHeader", b =>
                {
                    b.HasOne("Tangy.Areas.Identity.Data.TangyUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
